  ...
  \cventry
    ...
    {May. 2018 - Now} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Digital design}
        \begin{itemize}
          \item {\textbf{Top digital lead role in PCIe SoC (1GHz, 25M gates + memories, 22mm2, > 20 clock domains)}}
          \begin{itemize}
        ...
        \item {Silicon validation}
          \begin{itemize}
            ...
            \item {Extensive use of python libraries (pandas, numpy, matplotlib).}
          \end{itemize}
